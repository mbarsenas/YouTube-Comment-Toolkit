...
export async function POST(request: Request) {
  ...
  const response = await fetch("https://api.resend.com/emails", { method: "POST", headers: { authorization: `Bearer ${apiKey}`, "content-type": "application/json" }, body: JSON.stringify({ from: "CommentKit <commentkit@tenantiq365.com>", to: [normalized], subject: "Restore your CommentKit purchase", html: `<div style="font-family:Arial,sans-serif;max-width:560px;margin:auto"><h2>Restore CommentKit Pro</h2><p>Use the secure link below to restore lifetime access on this browser. It expires in 15 minutes and works once.</p><p><a href="${origin}/api/billing/recovery/confirm?token=${token}" style="display:inline-block;background:#17392f;color:white;padding:13px 18px;border-radius:8px;text-decoration:none">Restore purchase</a></p><p>If you did not request this, you can ignore this email.</p></div>` }) });
